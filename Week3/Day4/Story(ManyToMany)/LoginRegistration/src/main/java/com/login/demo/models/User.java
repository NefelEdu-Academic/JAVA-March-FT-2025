...
// attributes
	...
	public User() {
	 ...
	 public User(Long id,
			@NotBlank @Size(min = 3, max = 30, message = "Username must be between 3 and 30 characters") String name,
			@NotEmpty(message = "Email is required!") @Email(message = "Please enter a valid email!") String email,
			List<Story> myStories, List<Story> likedStories, int numberOfUpdate,
			...
			@NotEmpty(message = "Confirm Password is required!") @Size(min = 3, max = 128, message = "Confirm Password must be between 8 and 128 characters") String confirm,
